...
int main()
{
    ...
    Shader ourShader("src/shaders/7.4.camera_system.vs", "src/shaders/7.4.camera_system.fs");
    ...
    data = stbi_load(FileSystem::getPath("resources/textures/paulie.png").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
