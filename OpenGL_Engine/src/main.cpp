...
int main()
{
    ...
    // Initialize vertex buffer object, vertex array object, element buffer object
    ...
    // Make sure texture is not flipped upside down
    ...
    // load image, create texture and generate mipmaps
    data = stbi_load(FileSystem::getPath("resources/textures/awesome_face.png").c_str(), &width, &height, &nrChannels, 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Rotate 2d square over time, refresh every frame
